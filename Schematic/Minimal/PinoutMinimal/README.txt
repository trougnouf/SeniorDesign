...
Pinout:	{PB3, PA14, PA13, PC13}debugging, {PA2, PA3}USART2 (all female headers), {PC14, PC15, PH0, PH1, PA8, PA10, PA11, PA12}buttons/input
...
Notes:	
	...
	BT:	SDO (PCM Serial Data Output)
		SCKT (PCM Serial Clock Output)
		LRCKT (Left/Right Channel Selection Clock)
		OCLK	
	Clock:	Using 14.7456 MHz
Pinout:	PB9 (I2C_SDA), PB6 (I2C_SCL), PA7 (SDI), PA5 (SCK), PA4 (DATA_REQ), PB14 (RST)
...
*		GPIO9: essential (command mode)
	...
	Codec:	SPI (4 pins) or PCM (4 pins), using PCM
...
Datash:		http://www.st.com/web/en/resource/technical/document/datasheet/DM00057547.pdf
	MCU:
		SPC (SPI serial port clock)
		SDI (SPI serial data input)
		SDO (SPI serial data output)
		INT1 (interrupt, GPIO)				GPIO
		INT2 (interrupt, GPIO)				GPIO
	CS to 0, see datasheet for capacitors
Pinout:	PC2 (SDO), PC3 (SDI), PB10 (SPC), PB12 (INT1), PB13 (INT2)
